				...
				<div class="col-md-6">
					...
					<div class="action pull-right">
						...
						<ul>
							...
							<li><a href="loginform.do"><i class="fa fa-user"></i> 로그인</a></li>

							<li><a href="insertMember.do"><i class="fa fa-lock"></i> 회원가입</a></li>
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-4">
					...
					<div class="logo">
						...
						<a href="#"> <img src="resources/images/sidolLogo.png"
							alt="Orani E-shop">
