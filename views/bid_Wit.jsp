	...
	<div class="container">
		<div class="row row-cols-3">
			...
			<div class="col-lg-4">
				...
				<div class="card mb-4">
					<div class="card-body">
						...
						<a class="btn ms-lg-3 btn-primary" href="#1">이미지 가져오기</a><a
							class="btn ms-lg-3 btn-primary" href="#!">이미지 삭제하기</a>
			...
			<div class="col-lg-4">
				...
				<div class="card mb-4">
					<div class="card-body">
						<a class="btn ms-lg-5 btn-primary" href="#1">설정 가져오기</a> <a
							class="btn ms-lg-5 btn-primary" href="#!">저장</a>
					</div>
				</div>
