			...
			<div class="col-md-2  col-sm-2">
				<aside class="sidebar">
					...
					<ul class="inbox-nav inbox-divider">
						<li><a href="#"><i class="fa fa-inbox"></i> 공지사항 <!-- <span class="label label-danger pull-right">2</span> -->
						</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i> 자주묻는 질문</a></li>
						<li><a href="#"><i class="fa fa-bookmark-o"></i> 지원 서비스</a></li>
						<li><a href="#"><i class=" fa fa-external-link"></i> 경매
								이용안내 <!-- <span class="label label-info pull-right">30</span> -->
						</a></li>
						<li><a href="#"><i class=" fa fa-trash-o"></i> 경매 진행안내 </a></li>
						<li><a href="#"><i class=" fa fa-shopping-cart"></i> 수수료
								안내 </a></li>
						<li><a href="#"><i class=" fa fa-shopping-cart"></i> 배송
								비용 안내 </a></li>
							...
							<form action="" class="row g-3">
								...
								<div class="col-md-2">
									<div class="form-floating mb-2">
										...
										</select> <label for="floatingSelect">문의 주제</label>
									</div>
								</div>
								<div class="col-md-10">
									<div class="form-floating">
										<input type="text" class="form-control" id="floatingName"
											placeholder="Your Name"> <label for="floatingName">제목</label>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-floating">
									...
									<div class="input-group text-center">
										<input type="file" class="form-control"> <label
											class="input-group-text" for="inputGroupFile02">입력</label>
									</div>
								</div>
